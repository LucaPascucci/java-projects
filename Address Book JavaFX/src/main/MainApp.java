...
public class MainApp extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        this.primaryStage.setTitle("Rubrica");

        // Set the application icon.
        this.primaryStage.getIcons().add(new Image("file:res/address_book.png"));

        this.initRoootLayout();
     ...
     */
    private void initRoootLayout() throws IOException{
     ...
     */
    private void showPersonOverview() throws IOException{
    ...
    public void setPersonFilePath(File file) {
        ...
        if (file != null) {
            ...
            this.primaryStage.setTitle("Rubrica - " + file.getName());
        } else {
    ...
    public void showBirthdayStatistics() throws IOException{
            ...
            controller.setPersonData(this.personData);
