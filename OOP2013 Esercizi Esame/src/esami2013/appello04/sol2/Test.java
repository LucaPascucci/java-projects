 ...
 * Si realizzino quindi le classi Funghi, Salsiccia e Stesa come decoratori di Pizza, e quindi da usare in modo che il 
 ...
 * Per semplicità si assuma che la decorazione Stesa venga applicata solo una volta e in posizione più esterna, 
...
public class Test {
	...
	public void test(){
		...
		Pizza p4 = new Stesa(new Salsiccia(new Salsiccia(new Margherita())));
		// stampe di comodo
		...
		assertEquals(p4.getIngredients(),"[STESA] Pomodoro, Mozzarella, Salsiccia, Salsiccia");
