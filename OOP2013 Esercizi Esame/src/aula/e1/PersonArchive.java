...
public interface PersonArchive {
	 ...
	 *             , se il codice è già presente, o il nome è null
	 * @throws java.lang.UnsupportedOperationException
	 *             , se non è possibile aggiungere un nuovo nome per effetto del
	 *             metodo setLimit
	 */

	void addPerson(int code, String name)
			throws java.lang.IllegalArgumentException,
			java.lang.UnsupportedOperationException;

	/**
	 * @param code
	 *            , il codice da cercare
	...
	/**
	 * @return un array di nomi corrispondenti alle persone inserite: l'ordine
	 *         non è rilevante
	 */
	String[] getNames();

	/**
	 * Imposta un limite massimo al numero di persone. Funziona solo se il
	 * numero corrente di persone non è già maggiore.
	 * 
	 * @param n
	 *            , il numero max di persone
	 * @throws java.lang.IllegalArgumentException
	 *             se n è negativo, o se n è minore del numero attuale di
	 *             persone.
	 */
