...
public class Test {
	...
	public void testFibNext() {
		Generator g = new LastTwoBasedGenerator(1,1,new ClassicFib()); // completare nei puntini
	...
	public void testRecNext() {
		Generator g = new LastTwoBasedGenerator(100,100,new FibStrategy<Integer>(){
