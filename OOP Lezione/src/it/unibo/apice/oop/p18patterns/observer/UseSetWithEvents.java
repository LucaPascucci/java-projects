...
public class UseSetWithEvents{
	...
	public static void main(String[] args){
		...
		set.addEObserver(new EObserver<Integer>(){
			public void update(ESource<? extends Integer> s, Integer arg) {
				if (arg > 4){
					JOptionPane.showMessageDialog(null, "Dim. critica"); //finestra di dialogo anche senza bisogno di un JFrame
				}
			}
		...
		set.add("5");
		set.add("6");
		System.out.println(set.getCopy()); //ricordati che è un HashSet
	}
}
