...
import oop1314.lab02.constructors.sol.Smartphone;
...
public class PlayWithSmartphoneArrays {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("The number of smartphones with 1 CPU 2048 MB sd and 3g are: " + search(phones, 2, 8192, true));
  }
}
