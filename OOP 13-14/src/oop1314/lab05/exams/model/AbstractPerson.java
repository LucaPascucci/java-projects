...
public abstract class AbstractPerson implements IPerson {
	...
	/*
	 * TODO 1. Implement the compareTo method, sorting alphabetically by surname
	 */
	...
	public int compareTo (IPerson compara){
		return this.surname.compareTo(compara.getSurname());
	}
