...
/**
 * UseCheckBox a demo showing how use check boxes
 */
public class CustomizeGeek extends JPanel implements ItemListener {
  ...
  public CustomizeGeek() {
    ...
    //TODO add the listener for the remaining check boxes
    ...
    //TODO add further check boxes (hair, teeth, etc.)
  ...
  public void itemStateChanged(ItemEvent e) {
    ...
    if (source == chinCheckBox) {
      /* Keeps track of the corresponding char and index */
      index = CHIN_IDX;
      c = CHIN_CHAR;
      System.out.println(CHIN_STR + CHECKBOX_HAS_BEEN_CLICKED_MSG);
    }
    
    if (source == hairCheckBox) {
        /* Keeps track of the corresponding char and index */
        index = HAIR_IDX;
        c = HAIR_CHAR;
  ...
  public static void main(String[] args) {
    ...
    JFrame frame = new MyFrame("UseCheckBox", null);
