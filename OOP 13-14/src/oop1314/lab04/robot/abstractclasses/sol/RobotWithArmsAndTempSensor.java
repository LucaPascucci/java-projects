...
/**
 * Model a componible robot with two {@link oop1314.lab04.robot.abstractclasses.sol.RobotArm} and one {@link oop1314.lab04.robot.abstractclasses.sol.TempSensor}  
 * @author Andrea Santi
 *
 */
public class RobotWithArmsAndTempSensor extends ComposableRobot implements IComposableRobot, IRobotWithArms {
	...
	/**
	 * 
	 * @return The {@link oop1314.lab04.robot.abstractclasses.sol.TempSensor}
	 */
   ...
   * @return The current temperature perceived from the TempSensor
	...
	public double getCurrentTemp(){
		return this.getTemperatureSensor().readTempValue();  
	}
