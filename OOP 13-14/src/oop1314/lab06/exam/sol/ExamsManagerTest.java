...
import oop1314.lab06.exceptions.sol.CourseNotFoundException;
...
public final class ExamsManagerTest {
	...
	public static void main(final String[] args) {
      ...
      e.printStackTrace();
		...
		/* Cerco di aggiungere un esampe per in corso SISOP, che non è registrato */
		try {
      mgr.addExam(new Course("SISOP", 2014), calendar.getTime());
    } catch (CourseNotFoundException e) {
